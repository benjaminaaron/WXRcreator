...
function getEmbeddingSnippet(rawCode, landingpageLongTitle, landingpageTitle, landingpageURL, categoryURL){
    return rawCode.replace('$LANDINGPAGE_LONGTITLE$', landingpageLongTitle)
        .replace('$CATEGORY_URL$', categoryURL)
        .replace('$LANDINGPAGE_URL$', landingpageURL)
        .replace('$CATEGORY_URL$', categoryURL)
        .replace('$LANDINGPAGE_URL$', landingpageURL)
        .replace('$LANDINGPAGE_TITLE$', landingpageTitle);
};

function instantiatePageTemplate(title, content, pageID, urlPagename, parentID){
    return wxrPageTemplate.replace('$TITLE$', title)
        .replace('$CONTENT$', content)
        .replace('$ID$', pageID)
        .replace('$NAME$', urlPagename)
